...
input_path = "images/v2/patch43"
output_path = "label43/"

f = open('zhiyuan_objv2_val.json')    #the same script can be used for 'instances_train2017.json'
data = json.load(f)
f.close()
...
for filename in file_names:
    ...
    if img_ann:
        ...
        for ann in img_ann:
            current_category = ann['category_id'] - 1 #yolo category IDs start from 0 
