...
def fisheye_transform(filename, file_path, output_dir, n, scaling_factor):
    ...
    image_cropped.save(output_dir + filename[:])    #because n = 4
...
directory = 'Object365_Dataset/dataset/train/patch29'    #the same script can be used for 'train2017'
start = time.time()
count = 1
...
for filename in os.listdir(directory):
    ...
    count = count+1
    fisheye_transform(filename, file_path, 'patch29/', 4, scaling_factor)
