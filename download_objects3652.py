#credit is given to Kaining @https://github.com/KainingYing/SAM_Objects365. Run the script to also download the Objects365 dataset. 
#Visit @https://github.com/KainingYing/SAM_Objects365 for instructions on how to run the file.
